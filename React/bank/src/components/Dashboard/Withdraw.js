            ...
            <div className="relative z-10 max-w-6xl mx-auto w-full">
                ...
                <div className="bg-black bg-opacity-70 p-6 rounded-lg mb-6">
                    ...
                    <form onSubmit={handleSubmit}>
                        <h2 className="text-xl font-bold mb-4">Withdrawal Details</h2>
                        ...
                        <div className="mb-4">
                            ...
                            <p className="text-gray-400 text-sm mt-1">Maximum withdrawal: ${accountInfo.balance.toFixed(2)}</p>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            >
                                {isLoading ? 'Processing...' : 'Complete Withdrawal'}
                            </button>
                            <button 
                                type="button" 
