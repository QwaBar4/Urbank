...
const AdminLoanManagement = () => {
    ...
    useEffect(() => {
        const fetchLoans = async () => {
            try {
                // Use the new endpoint that filters by user ID
                const response = userId 
                    ? await api.getLoansByUserId(userId)
                    : await api.getAllLoans();
                        ...
                        <div className="pt-6 pb-4">
                            <div className="flex items-center justify-between mb-6">
                                <h1 className="text-2xl font-bold">
                                    {userId ? 'User Loan Management' : 'Loan Management'}
                                </h1>
                                <button 
                            ...
                            {loading ? (
                                ...
                                <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
                                    <h2 className="text-xl font-bold mb-4">
                                        {userId ? 'User Loan Applications' : 'All Loan Applications'}
                                    </h2>
