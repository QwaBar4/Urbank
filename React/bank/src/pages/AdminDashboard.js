            ...
            {showStatementOptions && (
              ...
              >
                <motion.div
                  ...
                  transition={{ duration: 0.2 }}
                  className="bg-gray-800 p-6 rounded-xl max-w-md w-full border border-gray-700"
                >
            ...
            {showTransactions !== null && (
              ...
              >
                <motion.div
                  variants={modalVariants}
                  transition={{ duration: 0.2 }}
                  className="bg-gray-800 p-6 rounded-lg max-w-4xl w-full border border-gray-700 max-h-[80vh] overflow-y-auto"
                >
